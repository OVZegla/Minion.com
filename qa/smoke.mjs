...
// Navigate pages
const routes = ['/calendrier','/matieres','/cours','/a-faire','/revisions','/flashcards','/fiches','/examens','/sae','/documents','/methodes','/swot','/jurisprudence','/lexique','/a-classer','/focus','/resultats','/parametres','/mon-annee'];
